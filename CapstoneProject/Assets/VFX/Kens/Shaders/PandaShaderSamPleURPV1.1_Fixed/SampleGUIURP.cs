...
public class SampleGUIURP : ShaderGUI
{
    ...
    MaterialProperty UseColorCurve = null;
    MaterialProperty RampColor1 = null;
    MaterialProperty RampColor2 = null;
    MaterialProperty RampColor3 = null;
    MaterialProperty RampThresh1 = null;
    MaterialProperty RampThresh2 = null;
 ...
 //   MaterialProperty CustomAlphaClip = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        UseColorCurve = FindProperty("_UseColorCurve", props);
        RampColor1 = FindProperty("_RampColor1", props);
        RampColor2 = FindProperty("_RampColor2", props);
        RampColor3 = FindProperty("_RampColor3", props);
        RampThresh1 = FindProperty("_RampThresh1", props);
        RampThresh2 = FindProperty("_RampThresh2", props);
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        if (_Main_Foldout)
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            m_MaterialEditor.ShaderProperty(UseColorCurve, "Use Procedural Ramp");
            if (material.GetFloat("_UseColorCurve") == 1)
            {
                EditorGUI.indentLevel++;
                m_MaterialEditor.ShaderProperty(RampColor1, "Shadow Color");
                m_MaterialEditor.ShaderProperty(RampColor2, "Midtone Color");
                m_MaterialEditor.ShaderProperty(RampColor3, "Highlight Color");
                m_MaterialEditor.ShaderProperty(RampThresh1, "Shadow->Mid Threshold");
                m_MaterialEditor.ShaderProperty(RampThresh2, "Mid->High Threshold");
                m_MaterialEditor.ShaderProperty(RampSmooth, "Blend Smoothness");
                EditorGUI.indentLevel--;
            }
            EditorGUILayout.EndVertical();
            GUILayout.Space(5);
