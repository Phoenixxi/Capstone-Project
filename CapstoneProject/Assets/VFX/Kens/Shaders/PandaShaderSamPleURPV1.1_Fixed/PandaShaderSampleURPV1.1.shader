...
Shader "VFX/PandaShader_Modified"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Enum(UnityEngine.Rendering.BlendMode)]_Scr("Blend Source", Float) = 5
		[Enum(UnityEngine.Rendering.BlendMode)]_Dst("Blend Destination", Float) = 10
		[Enum(UnityEngine.Rendering.CullMode)]_CullMode("Cull Mode", Float) = 0
		
		[Header(Procedural Color Ramp)]
		[Toggle]_UseColorCurve("Use Procedural Ramp", Float) = 0
		[HDR] _RampColor1("Shadow Color", Color) = (0,0,0,1)
		[HDR] _RampColor2("Midtone Color", Color) = (0.5,0.5,0.5,1)
		[HDR] _RampColor3("Highlight Color", Color) = (1,1,1,1)
		_RampThresh1("Shadow-Mid Threshold", Float) = 0.33
		_RampThresh2("Mid-High Threshold", Float) = 0.66
		_RampSmooth("Blend Smoothness", Range(0.001, 1)) = 0.1

		_MainTex("Main Texture", 2D) = "white" {}
		_VTOTex("Vertex Offset Texture", 2D) = "black" {}
		[Toggle]_VTOTexAR("Vertex Offset Alpha as RGB", Float) = 1
		[Toggle]_MainTexVMirror("Main Texture Mirror V", Float) = 0
		[Toggle]_RefactionMaskTexVMirror("Refraction Mask Mirror V", Float) = 0
		[Toggle]_RefactionTexVMirror("Refraction Texture Mirror V", Float) = 0
		[Toggle]_DistortTexVMirror("Distortion Texture Mirror V", Float) = 0
		[Toggle]_MaskTexVMirror("Mask Texture Mirror V", Float) = 0
		[Toggle]_DissolvePlusTexVMirror("Secondary Dissolve Mirror V", Float) = 0
		[Toggle]_VTOTexVMirror("Vertex Offset Mirror V", Float) = 0
		[Toggle]_DissolveTexVMirror("Dissolve Texture Mirror V", Float) = 0
		[Toggle]_MainTexVClamp("Main Texture Clamp V", Float) = 0
		[Toggle]_DissolveTexVClamp("Dissolve Texture Clamp V", Float) = 0
		[Toggle]_MaskTexVClamp("Mask Texture Clamp V", Float) = 0
		[Toggle]_DissolvePlusTexVClamp("Secondary Dissolve Clamp V", Float) = 0
		[Toggle]_VTOTexVClamp("Vertex Offset Clamp V", Float) = 0
		[Toggle]_MainTexUClamp("Main Texture Clamp U", Float) = 0
		[Toggle]_VTOTexUMirror("Vertex Offset Mirror U", Float) = 0
		[Toggle]_DissolvePlusTexUMirror("Secondary Dissolve Mirror U", Float) = 0
		[Toggle]_DissolveTexUMirror("Dissolve Texture Mirror U", Float) = 0
		[Toggle]_MaskTexUMirror("Mask Texture Mirror U", Float) = 0
		[Toggle]_RefactionTexUMirror("Refraction Texture Mirror U", Float) = 0
		[Toggle]_RefactionMaskTexUMirror("Refraction Mask Mirror U", Float) = 0
		[Toggle]_DistortTexUMirror("Distortion Texture Mirror U", Float) = 0
		[Toggle]_MainTexUMirror("Main Texture Mirror U", Float) = 0
		[Toggle]_MaskTexUClamp("Mask Texture Clamp U", Float) = 0
		[Toggle]_VTOTexUClamp("Vertex Offset Clamp U", Float) = 0
		[Toggle]_DissolvePlusTexUClamp("Secondary Dissolve Clamp U", Float) = 0
		[Toggle]_DissolveTexUClamp("Dissolve Texture Clamp U", Float) = 0
		[Toggle]_MainTexAR("Main Texture Alpha as RGB", Float) = 0
		[Toggle]_MainTexUVClip("Main Texture UV Clip", Float) = 1
		[Toggle]_DissolveTexUVClip("Dissolve Texture UV Clip", Float) = 1
		[Toggle]_DissolvePlusTexUVClip("Secondary Dissolve UV Clip", Float) = 1
		[Toggle]_VTOTexUVClip("Vertex Offset UV Clip", Float) = 1
		[Toggle]_MaskTexUVClip("Mask Texture UV Clip", Float) = 1
		[HDR]_MainColor("Main Color", Color) = (1,1,1,1)
		_VTOTexUSpeed("Vertex Offset U Speed", Float) = 0
		_MainTexDesaturate("Main Texture Desaturation", Range( 0 , 1)) = 0
		_DissolvePlusTexRotator("Secondary Dissolve Rotation", Range( 0 , 1)) = 0
		_VTOTexRotator("Vertex Offset Rotation", Range( 0 , 1)) = 0
		_DissolveTexRotator("Dissolve Texture Rotation", Range( 0 , 1)) = 0
		_MaskTexRotator("Mask Texture Rotation", Range( 0 , 1)) = 0
		_RefactionFactor("Refraction Factor", Range( 0 , 1)) = 0
		_DistortTexRotator("Distortion Texture Rotation", Range( 0 , 1)) = 0
		_RefactionMaskTexRotator("Refraction Mask Rotation", Range( 0 , 1)) = 0
		_RefactionTexRotator("Refraction Texture Rotation", Range( 0 , 1)) = 0
		_MainTexCAFator("Main Texture Chromatic Aberration", Range( 0 , 0.1)) = 0
		_MainTexRotator("Main Texture Rotation", Range( 0 , 1)) = 0
		_MainTexUSpeed("Main Texture U Speed", Float) = 0
		_MainTexVSpeed("Main Texture V Speed", Float) = 0
		_VTOTexVSpeed("Vertex Offset V Speed", Float) = 0
		[Toggle]_CustomMainTexUOffset("Custom Main Texture U Offset", Float) = 0
		[Toggle]_CustomMainTexVOffset("Custom Main Texture V Offset", Float) = 0
		[Toggle(_FMASKTEX_ON)] _FMaskTex("Enable Mask Texture", Float) = 0
		_MaskTex("Mask Texture", 2D) = "white" {}
		[Toggle]_MaskTexAR("Mask Texture Alpha as RGB", Float) = 1
		_MaskTexUSpeed("Mask Texture U Speed", Float) = 0
		_MaskTexVSpeed("Mask Texture V Speed", Float) = 0
		[Toggle(_FDISTORTTEX_ON)] _FDistortTex("Enable Distortion", Float) = 0
		_DistortTex("Distortion Texture", 2D) = "white" {}
		_RefactionTex("Refraction Texture", 2D) = "white" {}
		_RefactionMaskTex("Refraction Mask", 2D) = "white" {}
		[Toggle]_RefactionMaskTexAR("Refraction Mask Alpha as RGB", Float) = 1
		[Toggle]_RefactionTexAR("Refraction Texture Alpha as RGB", Float) = 1
		[Toggle]_DistortTexAR("Distortion Texture Alpha as RGB", Float) = 1
		_DistortFactor("Distortion Factor", Range( 0 , 1)) = 0
		_DistortTexUSpeed("Distortion Texture U Speed", Float) = 0
		_RefactionMaskTexUSpeed("Refraction Mask U Speed", Float) = 0
		_RefactionTexUSpeed("Refraction Texture U Speed", Float) = 0
		_DistortTexVSpeed("Distortion Texture V Speed", Float) = 0
		_RefactionTexVSpeed("Refraction Texture V Speed", Float) = 0
		_RefactionMaskTexVSpeed("Refraction Mask V Speed", Float) = 0
		[Toggle]_DistortMainTex("Distort Main Texture", Float) = 0
		[Toggle]_DistortMaskTex("Distort Mask Texture", Float) = 0
		[Toggle]_DistortDissolveTex("Distort Dissolve Texture", Float) = 0
		[Toggle(_FDISSOLVETEX_ON)] _FDissolveTex("Enable Dissolve", Float) = 0
		_DissolvePlusTex("Secondary Dissolve Texture", 2D) = "black" {}
		_DissolveTex("Dissolve Texture", 2D) = "white" {}
		[Toggle]_DissolveTexAR("Dissolve Texture Alpha as RGB", Float) = 1
		[Toggle]_DissolvePlusTexAR("Secondary Dissolve Alpha as RGB", Float) = 1
		[HDR]_DissolveColor("Dissolve Color", Color) = (1,1,1,1)
		[Toggle]_CustomDissolve("Custom Dissolve", Float) = 0
		_DissolveFactor("Dissolve Factor", Range( 0 , 1)) = 0
		_DissolveSoft("Dissolve Softness", Range( 0 , 1)) = 0.1
		_DissolveWide("Dissolve Width", Range( 0 , 1)) = 0.05
		_DissolvePlusTexUSpeed("Secondary Dissolve U Speed", Float) = 0
		_DissolveTexUSpeed("Dissolve Texture U Speed", Float) = 0
		_DissolvePlusTexVSpeed("Secondary Dissolve V Speed", Float) = 0
		_DissolveTexVSpeed("Dissolve Texture V Speed", Float) = 0
		_MainAlpha("Main Alpha", Range( 0 , 10)) = 1
		[Toggle(_FFNL_ON)] _FFnl("Enable Fresnel", Float) = 0
		[HDR]_FnlColor("Fresnel Color", Color) = (1,1,1,1)
		_FnlScale("Fresnel Scale", Range( 0 , 2)) = 0
		[Toggle(_FDEPTH_ON)] _FDepth("Enable Depth Fade", Float) = 0
		_FnlPower("Fresnel Power", Range( 1 , 10)) = 1
		[Toggle]_ReFnl("Reverse Fresnel", Float) = 0
		[Enum(Alpha,0,Add,1)]_BlendMode("Blend Mode", Float) = 0
		[Enum(UnityEngine.Rendering.CompareFunction)]_ZTest("Z Test", Float) = 4
		_DepthFade("Depth Fade Distance", Range( 0 , 10)) = 1
		[Toggle(_IFVTO_ON)] _IfVTO("Enable Vertex Offset", Float) = 0
		[Toggle]_CustomVTO("Custom Vertex Offset", Float) = 0
		_VTOScale("Vertex Offset Scale", Float) = 1
		[Toggle(_FDISSOLVEPLUSTEX_ON)] _FDissolvePlusTex("Enable Secondary Dissolve", Float) = 0
		_DissolvePlusIntensity("Secondary Dissolve Intensity", Range( 0 , 1)) = 0.5
		[IntRange]_DissolveTexUOffsetC("Dissolve Tex U Offset Channel", Range( 1 , 8)) = 1
		[IntRange]_DissolvePlusTexUOffsetC("Sec Dissolve U Offset Channel", Range( 1 , 8)) = 1
		[IntRange]_DissolveTexVOffsetC("Dissolve Tex V Offset Channel", Range( 1 , 8)) = 1
		[IntRange]_DissolvePlusTexVOffsetC("Sec Dissolve V Offset Channel", Range( 1 , 8)) = 1
		[IntRange]_MaskTexUOffsetC("Mask Tex U Offset Channel", Range( 1 , 8)) = 1
		[IntRange][Enum(none,0,Custom1x,1,Custom1y,2,Custom1z,3,Custom1w,4,Custom2x,5,Custom2y,6,Custom2z,7,Custom2w,8)]_MainTexUOffsetC("Main Tex U Offset Channel", Range( 1 , 8)) = 1
		[IntRange][Enum(none,0,Custom1x,1,Custom1y,2,Custom1z,3,Custom1w,4,Custom2x,5,Custom2y,6,Custom2z,7,Custom2w,8)]_MainTexVOffsetC("Main Tex V Offset Channel", Range( 1 , 8)) = 1
		[IntRange][Enum(none,0,Custom1x,1,Custom1y,2,Custom1z,3,Custom1w,4,Custom2x,5,Custom2y,6,Custom2z,7,Custom2w,8)]_VTOScaleC("Vertex Offset Scale Channel", Range( 1 , 8)) = 1
		[IntRange][Enum(none,0,Custom1x,1,Custom1y,2,Custom1z,3,Custom1w,4,Custom2x,5,Custom2y,6,Custom2z,7,Custom2w,8)]_DissolveFactorC("Dissolve Factor Channel", Range( 1 , 8)) = 1
		[IntRange][Enum(none,0,Custom1x,1,Custom1y,2,Custom1z,3,Custom1w,4,Custom2x,5,Custom2y,6,Custom2z,7,Custom2w,8)]_DistortFactorC("Distortion Factor Channel", Range( 1 , 8)) = 1
		[IntRange][Enum(none,0,Custom1x,1,Custom1y,2,Custom1z,3,Custom1w,4,Custom2x,5,Custom2y,6,Custom2z,7,Custom2w,8)]_RefactionFactorC("Refraction Factor Channel", Range( 1 , 8)) = 1
		[Toggle]_CustomDissolveTexUOffset("Custom Dissolve U Offset", Float) = 0
		[Toggle]_CustomDissolvePlusTexUOffset("Custom Sec Dissolve U Offset", Float) = 0
		[Toggle]_CustomMaskTexUOffset("Custom Mask U Offset", Float) = 0
		[Toggle]_CustomDissolveTexVOffset("Custom Dissolve V Offset", Float) = 0
		[Toggle]_CustomDissolvePlusTexVOffset("Custom Sec Dissolve V Offset", Float) = 0
		[Toggle]_CustomMaskTexVOffset("Custom Mask V Offset", Float) = 0
		[IntRange]_MaskTexVOffsetC("Mask Tex V Offset Channel", Range( 1 , 8)) = 1
		[Toggle]_CustomRefactionFactor("Custom Refraction Factor", Float) = 0
		[Toggle]_CustomDistortFactor("Custom Distortion Factor", Float) = 0
		[Toggle]_DistortUIntensity("Distortion U Intensity", Float) = 1
		[Toggle]_DistortVIntensity("Distortion V Intensity", Float) = 1
		[Toggle]_RefactionRemap("Refraction Remap", Float) = 0
		[Toggle]_DistortRemap("Distortion Remap", Float) = 0
		_MainTexRefine("Main Texture Refinement", Vector) = (1,1,1,0)
		[Toggle]_MainTexDetail("Main Texture Detail", Float) = 0
		[Toggle]_RefactionTexDetail("Refraction Texture Detail", Float) = 0
		[Toggle]_RefactionMaskTexDetail("Refraction Mask Detail", Float) = 0
		[Toggle]_MaskTexDetail("Mask Texture Detail", Float) = 0
		[Toggle]_DissolveTexDetail("Dissolve Texture Detail", Float) = 0
		[Toggle]_DistortTexDetail("Distortion Texture Detail", Float) = 0
		[Toggle]_DissolvePlusTexDetail("Secondary Dissolve Detail", Float) = 0
		[Toggle(_IFREFACTIONMASK_ON)] _IfRefactionMask("Enable Refraction Mask", Float) = 0
		[Toggle]_VTOTexDetail("Vertex Offset Detail", Float) = 0
		[Toggle(_IFREFACTION_ON)] _IfRefaction("Enable Refraction", Float) = 0
		[Toggle]_RefactionMaskTexVClamp("Refraction Mask Clamp V", Float) = 0
		[Toggle]_RefactionMaskTexUClamp("Refraction Mask Clamp U", Float) = 0
		[Toggle]_RefactionMaskTexUVClip("Refraction Mask UV Clip", Float) = 0
		_SB("Stencil Reference", Float) = 0
		[Enum(Off,0,Mask,8,Clip,3)]_SBCompare("Stencil Compare", Float) = 0
		_AlphaClip("Alpha Clip Threshold", Range( 0 , 1)) = 0
		[ASEEnd][Enum(RGBA,14,A,0)]_MainRGBA("Color Mask", Float) = 14
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				// Procedural 3-Point Ramp
				float blend1 = smoothstep(_RampThresh1 - _RampSmooth, _RampThresh1 + _RampSmooth, desaturateDot36_g143);
				float blend2 = smoothstep(_RampThresh2 - _RampSmooth, _RampThresh2 + _RampSmooth, desaturateDot36_g143);
				
				float4 proceduralCurve = lerp(_RampColor1, _RampColor2, blend1);
				proceduralCurve = lerp(proceduralCurve, _RampColor3, blend2);
				
				float4 finalMainColor = lerp(float4(desaturateVar36_g143, 0.0), proceduralCurve, _UseColorCurve);
				float4 MainTexColor215 = ( _MainColor * finalMainColor );
